...
[
    .init(light: PeerLight(), dark: PeerDark()),
    .init(light: PeerNeonLight(), dark: PeerNeonDark()),
...
public enum ColorSetName: String, Sendable {
  case peerDark = "Peer - Dark"
  case peerLight = "Peer - Light"
  case peerNeonDark = "Peer Neon - Dark"
  case peerNeonLight = "Peer Neon - Light"
...
public struct PeerDark: ColorSet {
  public var name: ColorSetName = .peerDark
...
public struct PeerLight: ColorSet {
  public var name: ColorSetName = .peerLight
...
public struct PeerNeonDark: ColorSet {
  public var name: ColorSetName = .peerNeonDark
  public var scheme: ColorScheme = .dark
...
public struct PeerNeonLight: ColorSet {
  public var name: ColorSetName = .peerNeonLight
  public var scheme: ColorScheme = .light
  public var tintColor: Color = .init(red: 213 / 255, green: 46 / 255, blue: 245 / 255)
  public var primaryBackgroundColor: Color = .white
  public var secondaryBackgroundColor: Color = .init(hex: 0xF0F1F2)

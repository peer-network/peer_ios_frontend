...
public class RefreshTokenMutation: GraphQLMutation {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"mutation RefreshToken($refreshToken: String!) { refreshToken(refreshToken: $refreshToken) { __typename accessToken refreshToken meta { __typename status RequestId ResponseCode ResponseMessage } } }"#
    ))
  ...
  public struct Data: GQLOperationsGuest.SelectionSet {
    ...
    public struct RefreshToken: GQLOperationsGuest.SelectionSet {
      ...
      public struct Meta: GQLOperationsGuest.SelectionSet {
        ...
        public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          RefreshTokenMutation.Data.RefreshToken.Meta.self
        ] }

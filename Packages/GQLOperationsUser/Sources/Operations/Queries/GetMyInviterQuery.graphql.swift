...
public class GetMyInviterQuery: GraphQLQuery {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query GetMyInviter { referralList { __typename meta { __typename status RequestId ResponseCode ResponseMessage } affectedRows { __typename invitedBy { __typename id username slug img visibilityStatus hasActiveReports isHiddenForUsers isfollowed isfollowing isfriend } } } }"#
    ))
  ...
  public struct Data: GQLOperationsUser.SelectionSet {
    ...
    public struct ReferralList: GQLOperationsUser.SelectionSet {
      ...
      public struct Meta: GQLOperationsUser.SelectionSet {
        ...
        public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          GetMyInviterQuery.Data.ReferralList.Meta.self
        ] }

...
public class GetTransactionHistoryQuery: GraphQLQuery {
  ...
  public struct Data: GQLOperationsUser.SelectionSet {
    ...
    /// TransactionHistory
    ///
    /// Parent Type: `TransactionHistoryResponse`
    public struct TransactionHistory: GQLOperationsUser.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }

      public static var __parentType: any ApolloAPI.ParentType { GQLOperationsUser.Objects.TransactionHistoryResponse }
      public static var __selections: [ApolloAPI.Selection] { [
      ...
      ///
      /// Parent Type: `TransactionHistoryItem`
      public struct AffectedRow: GQLOperationsUser.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

        public static var __parentType: any ApolloAPI.ParentType { GQLOperationsUser.Objects.TransactionHistoryItem }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),

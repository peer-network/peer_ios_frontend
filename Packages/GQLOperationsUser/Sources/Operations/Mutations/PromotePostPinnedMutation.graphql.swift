...
public class PromotePostPinnedMutation: GraphQLMutation {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"mutation PromotePostPinned($postid: ID!) { advertisePostPinned(postid: $postid, advertisePlan: PINNED) { __typename status ResponseCode affectedRows { __typename timeframeEnd } } }"#
    ))

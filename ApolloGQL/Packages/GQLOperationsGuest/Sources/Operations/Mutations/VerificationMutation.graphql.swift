...
public class VerificationMutation: GraphQLMutation {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"mutation Verification($userid: ID!) { verifyAccount(userid: $userid) { __typename status RequestId ResponseCode ResponseMessage } }"#
    ))
  ...
  public struct Data: GQLOperationsGuest.SelectionSet {
    ...
    public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
      VerificationMutation.Data.self
    ] }
    ...
    public struct VerifyAccount: GQLOperationsGuest.SelectionSet {
      ...
      public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        VerificationMutation.Data.VerifyAccount.self
      ] }

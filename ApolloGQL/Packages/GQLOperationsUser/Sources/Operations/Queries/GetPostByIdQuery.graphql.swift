...
public class GetPostByIdQuery: GraphQLQuery {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query GetPostById($postid: ID!) { listPosts(postid: $postid, contentFilterBy: MYGRANDMAHATES) { __typename meta { __typename status RequestId ResponseCode ResponseMessage } counter affectedRows { __typename id contenttype title media cover mediadescription createdat visibilityStatus isHiddenForUsers hasActiveReports amountlikes amountviews amountcomments amountdislikes amounttrending isliked isviewed isreported isdisliked issaved tags url user { __typename id username slug img visibilityStatus hasActiveReports isHiddenForUsers isfollowed isfollowing isfriend } } } }"#
    ))
  ...
  public struct Data: GQLOperationsUser.SelectionSet {
    ...
    public struct ListPosts: GQLOperationsUser.SelectionSet {
      ...
      public struct Meta: GQLOperationsUser.SelectionSet {
        ...
        public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          GetPostByIdQuery.Data.ListPosts.Meta.self
        ] }

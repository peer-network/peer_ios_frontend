...
public class PostInteractionsQuery: GraphQLQuery {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query PostInteractions($getOnly: GetOnly!, $postOrCommentId: ID!, $offset: Int, $limit: Int) { postInteractions( getOnly: $getOnly postOrCommentId: $postOrCommentId offset: $offset limit: $limit ) { __typename status ResponseCode affectedRows { __typename id username slug img isfollowed isfollowing } } }"#
    ))

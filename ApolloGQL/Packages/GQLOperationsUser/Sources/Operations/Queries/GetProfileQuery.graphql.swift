...
public class GetProfileQuery: GraphQLQuery {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query GetProfile($contentFilterBy: ContentFilterType, $userid: ID!) { getProfile(contentFilterBy: $contentFilterBy, userid: $userid) { __typename meta { __typename status RequestId ResponseCode ResponseMessage } affectedRows { __typename id username status slug img biography visibilityStatus isHiddenForUsers hasActiveReports isfollowed isfollowing amountposts amounttrending amountfollowed amountfollower amountfriends amountblocked amountreports } } }"#
    ))
  ...
  public struct Data: GQLOperationsUser.SelectionSet {
    ...
    public struct GetProfile: GQLOperationsUser.SelectionSet {
      ...
      public struct Meta: GQLOperationsUser.SelectionSet {
        ...
        public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          GetProfileQuery.Data.GetProfile.Meta.self
        ] }

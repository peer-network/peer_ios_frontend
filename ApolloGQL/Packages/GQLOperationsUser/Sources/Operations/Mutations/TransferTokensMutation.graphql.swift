...
public class TransferTokensMutation: GraphQLMutation {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"mutation TransferTokens($recipient: ID!, $numberoftokens: Decimal!, $message: String) { resolveTransferV2( recipient: $recipient numberoftokens: $numberoftokens message: $message ) { __typename meta { __typename status RequestId ResponseCode ResponseMessage } } }"#
    ))
  ...
  public struct Data: GQLOperationsUser.SelectionSet {
    ...
    public struct ResolveTransferV2: GQLOperationsUser.SelectionSet {
      ...
      public struct Meta: GQLOperationsUser.SelectionSet {
        ...
        public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          TransferTokensMutation.Data.ResolveTransferV2.Meta.self
        ] }

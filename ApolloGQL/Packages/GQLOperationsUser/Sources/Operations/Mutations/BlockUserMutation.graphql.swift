...
public class BlockUserMutation: GraphQLMutation {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"mutation BlockUser($userid: ID!) { userBlock(userid: $userid) { __typename status ResponseCode } }"#
    ))
  ...
  public struct Data: GQLOperationsUser.SelectionSet {
    ...
    public static var __selections: [ApolloAPI.Selection] { [
      .field("userBlock", UserBlock.self, arguments: ["userid": .variable("userid")]),
    ] }

    public var userBlock: UserBlock { __data["userBlock"] }

    /// UserBlock
    ///
    /// Parent Type: `DefaultResponse`
    public struct UserBlock: GQLOperationsUser.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }
